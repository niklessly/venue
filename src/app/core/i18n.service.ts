...
const RU = {
  ...
  availableRooms: 'залы',
  authDescription: 'Выберите подходящее время, зал и оборудование без лишних сообщений.',
...
const EN: Record<TranslationKey, string> = {
  ...
  authDescription: 'Choose the right time, room and equipment without extra noise.',
