...
const RU = {
  ...
  equipmentPlaceholder: 'проектор, доска или зал 4',
  filterStepText: 'Укажите дату, время, размер команды и нужное оборудование.',
  filterStepTitle: 'Подберите зал',
  freeRoom: 'свободный зал',
  inRoom: 'в',
  language: 'язык',
  location: 'локация',
  login: 'вход',
  loginLead: 'Войдите, чтобы выбрать зал, создать бронь и управлять встречами.',
  loginVisualLead: 'простой сервис бронирования переговорных в мягком розово-жёлтом стиле.',
  logout: 'выйти',
  manageStepText: 'На странице бронирований можно перенести, отменить или удалить встречу.',
  manageStepTitle: 'Управляйте бронями',
  ...
  password: 'пароль',
  pickStepText: 'Откройте карточку, проверьте расписание и нажмите «Забронировать зал».',
  pickStepTitle: 'Проверьте детали',
  ...
  time: 'время',
  today: 'сегодня',
  upcomingNotifications: 'ближайшие встречи',
  upcomingRooms: 'задействованные залы',
  utilization: 'загрузка',
  welcomeBack: 'добро пожаловать',
  workflowLabel: 'что сделать дальше',
} as const;
...
const EN: Record<TranslationKey, string> = {
  ...
  equipmentPlaceholder: 'projector, whiteboard or room 4',
  filterStepText: 'Set date, time, team size and required equipment.',
  filterStepTitle: 'Find a room',
  freeRoom: 'free room',
  inRoom: 'in',
  language: 'language',
  location: 'location',
  login: 'login',
  loginLead: 'Sign in to choose rooms, create bookings and manage your schedule.',
  loginVisualLead: 'simple room booking service with a soft pink and yellow interface.',
  logout: 'logout',
  manageStepText: 'Use bookings to move, cancel or delete a meeting.',
  manageStepTitle: 'Manage bookings',
  ...
  password: 'password',
  pickStepText: 'Open a room, check the schedule and book it.',
  pickStepTitle: 'Check details',
